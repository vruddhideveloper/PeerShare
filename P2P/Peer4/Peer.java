        ...
        public void run() {
            ...
            try {
                ...
                while (sChunkID.size() != foChunkIDSize) {
                    ...
                    System.out
                            .println("Peer " + selfPort + " has requested chunk " + randNum + " from peer " + downPort);
                    ...
                    System.out.println("Peer " + downPort + " has received its missing chunk " + randNum + " from peer "
                            + selfPort);
        ...
        public void run() {
            ...
            try {
                ...
                while (true) {
                    ...
                    System.out.println(
                            "Peer " + selfPort + " has received request for chunk " + randNum + " from upload peer ");
